...
namespace HotelBookingAPI.Migrations
{
    ...
    [Migration("20250824141508_initial migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelBookingAPI.Models.DomainModels.Payment", b =>
                {
                    ...
                    b.HasIndex(new[] { "TransactionId" }, "IX_Payment_TransactionId_Unique")
                        .IsUnique();
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 4000m,
                            BookingId = 1,
                            PaymentDate = new DateTime(2025, 8, 25, 12, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("HotelBookingAPI.Models.DomainModels.Payment", b =>
                {
                    b.HasOne("HotelBookingAPI.Models.DomainModels.Booking", "Booking")
                        .WithOne("Payment")
                        .HasForeignKey("HotelBookingAPI.Models.DomainModels.Payment", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
